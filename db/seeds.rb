...
users = User.create(
  [
    ...
    { username: 'Melanie', email: 'mel@mail.com', password: 'password'},
    { username: 'Jon', email: 'jon@mail.com', password: 'password'},    
    { username: 'Crystal', email: 'crystal@mail.com', password: 'password'},    
    { username: 'Sophia', email: 'sophia@mail.com', password: 'password'},
    { username: 'Brad', email: 'brad@mail.com', password: 'password'},
    { username: 'Jen', email: 'jen@mail.com', password: 'password'},
  ]
  )

Project.create(
  [
    {name: 'Marketing Proposal', deadline: Date.new(2020, 12, 4)},
    {name: 'Systems Conversion', deadline: Date.new(2019, 5, 4)},
    {name: 'Budget 2020', deadline: Date.new(2019, 6, 4)},
    {name: 'Compliance 2020', deadline: Date.new(2019, 7, 3)}
  ]
)
